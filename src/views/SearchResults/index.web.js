...
class SearchResultsContainer extends Component {
  ...
  fetchPage = (page = 1, text) => {
    ...
    const apiQuery = qs.stringify({...query, page: page, text: query['q'], sort: 'updated_at:desc'})
    const browserQuery = qs.stringify({...query, q: query['q'], page: page})
    ...
    fetch(`https://sketchpacks-api.herokuapp.com/v1/plugins?${apiQuery}`)
      ...
      .then(json => {
        ...
        browserHistory.push(`/search?${browserQuery}`)
      })
  }
        ...
        <section className="hero is-primary">
          <div className="hero-body">
            <div className="container">
              <h1 className="title">
                We've found X many plugin search results
              </h1>
            </div>
          </div>
        </section>
